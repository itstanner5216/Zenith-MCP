// SageRank AST Integration Test
// Run: node tests/sagerank-ast-test.js

import { SageRank } from '../../zenith-toon/dist/sagerank.js';
...
console.log('\n\n=== RAW DATA ===');
console.log('textOnly.scores:', textOnly.scores);
console.log('withAST.scores:', withAST.scores);
console.log('textOnly.stats:', textOnly.stats);
console.log('withAST.stats:', withAST.stats);
