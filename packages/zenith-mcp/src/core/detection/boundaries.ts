...
export function findProjectBoundary(
    ...
    const compute = (): BoundaryResult | null => {
        ...
        // Reject junk evidence BEFORE clamping. Otherwise a junk ancestor such
        // as the home directory can be "laundered" into a valid-looking
        // allowed subdirectory and incorrectly become a detected project root.
