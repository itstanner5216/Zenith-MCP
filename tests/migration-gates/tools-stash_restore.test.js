...
const ORIGINAL = path.resolve('dist', 'tools', 'stash_restore.js');
const COMPILED = path.resolve('dist', 'tools', 'stash_restore.js');
...
describe('MIGRATION GATE: tools/stash_restore.js', () => {
