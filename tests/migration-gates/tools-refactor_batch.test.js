...
const ORIGINAL = path.resolve('dist', 'tools', 'refactor_batch.js');
const COMPILED = path.resolve('dist', 'tools', 'refactor_batch.js');
...
describe('MIGRATION GATE: tools/refactor_batch.js', () => {
