...
const ORIGINAL = path.resolve('dist', 'tools', 'search_files.js');
const COMPILED = path.resolve('dist', 'tools', 'search_files.js');
...
describe('MIGRATION GATE: tools/search_files.js', () => {
