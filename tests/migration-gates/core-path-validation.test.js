...
const ORIGINAL = path.resolve('dist', 'core', 'path-validation.js');
const COMPILED = path.resolve('dist', 'core', 'path-validation.js');
...
describe('MIGRATION GATE: core/path-validation.js', () => {
