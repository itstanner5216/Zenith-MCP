...
const ORIGINAL = path.resolve('dist', 'tools', 'read_multiple_files.js');
const COMPILED = path.resolve('dist', 'tools', 'read_multiple_files.js');
...
describe('MIGRATION GATE: tools/read_multiple_files.js', () => {
