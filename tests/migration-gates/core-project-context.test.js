...
const ORIGINAL = path.resolve('dist', 'core', 'project-context.js');
const COMPILED = path.resolve('dist', 'core', 'project-context.js');
...
describe('MIGRATION GATE: core/project-context.js', () => {
