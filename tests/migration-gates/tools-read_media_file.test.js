...
const ORIGINAL = path.resolve('dist', 'tools', 'read_media_file.js');
const COMPILED = path.resolve('dist', 'tools', 'read_media_file.js');
...
describe('MIGRATION GATE: tools/read_media_file.js', () => {
