...
const ORIGINAL = path.resolve('dist', 'tools', 'search_file.js');
const COMPILED = path.resolve('dist', 'tools', 'search_file.js');
...
describe('MIGRATION GATE: tools/search_file.js', () => {
