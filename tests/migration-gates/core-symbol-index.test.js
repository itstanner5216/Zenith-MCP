...
const ORIGINAL = path.resolve('dist', 'core', 'symbol-index.js');
const COMPILED = path.resolve('dist', 'core', 'symbol-index.js');
...
describe('MIGRATION GATE: core/symbol-index.js', () => {
