...
export async function getSymbolSummaryString(source: string, langName: string): Promise<string | null> {
    [TRUNCATED: lines 248-277]

function pluralize(type: string): string {
    [TRUNCATED: lines 279-298]
